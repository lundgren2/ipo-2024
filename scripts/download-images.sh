...
download_image "https://source.unsplash.com/400x400/?business,company,logo" "public/images/default-company-logo.png"

# Check if all images exist
for img in reddit-ipo.jpg shein-ipo.jpg stripe-ipo.jpg default-company-logo.png; do
